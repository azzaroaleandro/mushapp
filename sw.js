const CACHE='mushapp-shell-v1';
const FILES=['./','./index.html','./styles.css','./icon.svg','./manifest.webmanifest','./src/app.js','./src/data.js','./src/engine.js','./src/weather.js','./src/storage.js'];
