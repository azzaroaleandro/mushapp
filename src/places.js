...
export const CAMPIGLIO_LOCAL_RULE='Nei settori del Parco Adamello Brenta dei Comuni associati, la fonte locale prevede raccolta per residenti in Trentino o turisti con almeno cinque giorni consecutivi di soggiorno, con denuncia e pagamento quando dovuti. Il permesso ordinario non vale automaticamente in ogni settore del parco.';
export const EXTRA_AREAS=[
 {id:'campiglio',name:'Campiglio · boschi di Vallesinella',region:'TN',province:'TN',lat:46.213,lon:10.839,altitude:'1.300–1.700 m',hosts:['abete','faggio'],habitat:'Boschi montani misti e abetine',terrain:'Area indicativa a sud di Madonna di Campiglio, nel contesto del Parco Adamello Brenta. Verificare regole e accessi locali.',permit:CAMPIGLIO_RULES,localRule:CAMPIGLIO_LOCAL_RULE},
 {id:'nambrone',name:'Val Nambrone · fascia bassa',region:'TN',province:'TN',lat:46.203,lon:10.768,altitude:'1.000–1.500 m',hosts:['abete','faggio'],habitat:'Boschi montani della Val Rendena',terrain:'Punto indicativo della valle, non sentiero né posto di raccolta verificato. Accessi e divieti possono variare.',permit:CAMPIGLIO_RULES,localRule:CAMPIGLIO_LOCAL_RULE},
 {id:'rendena',name:'Alta Val Rendena · Carisolo',region:'TN',province:'TN',lat:46.177,lon:10.742,altitude:'800–1.300 m',hosts:['abete','faggio'],habitat:'Boschi misti dei versanti',terrain:'Fascia più bassa rispetto a Campiglio. Quote, esposizione e particelle devono essere verificate sul posto.',permit:CAMPIGLIO_RULES,localRule:CAMPIGLIO_LOCAL_RULE},
