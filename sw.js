const CACHE='mushapp-shell-v4';
const FILES=['./','./index.html','./styles.css','./icon.svg','./manifest.webmanifest','./src/app.js?v=0.2.1','./src/data.js','./src/places.js','./src/catalog.js?v=0.2.1','./src/catalog-data.js','./src/catalog-media.js','./src/catalog-api.js?v=0.2.1','./src/recommendations.js','./src/engine.js','./src/weather.js','./src/storage.js'];
